...
namespace Walnut.Areas.Admin.Controllers
{
    public class DashboardController : Controller
    {
        ...
        {
            return View(await db.Dashboards.ToListAsync());
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Description,RoleId")] Dashboard dashboard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Description,RoleId")] Dashboard dashboard)
        {
            if (ModelState.IsValid)
            {
